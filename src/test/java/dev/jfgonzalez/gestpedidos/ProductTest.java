...
class ProductTest {
    ...
    void testPhysicalProdCalcPrice() {
        PhysicalProduct physicalProduct = new PhysicalProduct(1,"Detergente", 20.0f);

        float finalPrice = physicalProduct.calcFinalPrice();
    ...
    void testNegativePriceThrowsException() {
        assertThrows(IllegalArgumentException.class, () -> {
            ...
            new PhysicalProduct(1,"Error Product", -5.0f);
    ...
    void testDigitalPriceNotEqualsBase() {
        DigitalProduct digitalProduct = new DigitalProduct(1,"Video", 50.0f, "Lic", 10.0f);
        float finalPrice = digitalProduct.calcFinalPrice();
    ...
    void testPhysicalPriceNotEqualsBase() {
        PhysicalProduct physicalProduct = new PhysicalProduct(1,"Detergente", 100.0f);
        float finalPrice = physicalProduct.calcFinalPrice();
    ...
    void testProductCoverage() {
        PhysicalProduct p = new PhysicalProduct(1,"Duff", 10.0f);
        ...
        DigitalProduct d = new DigitalProduct(2,"Video", 5.0f, "Lic", 100.0f);
